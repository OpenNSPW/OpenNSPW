...
// scenario_305
internal static class Sub428C60
{
	public static void Call(Emulator emulator)
	{
		...
		emulator.Memory32[new Register32(0x00489AB4/*4758196*/)] = emulator.Cpu.Mov(new Register32(0xC0C09000/*3233845248*/));
		emulator.Memory32[new Register32(0x00489AB8/*4758200*/)] = emulator.Cpu.Mov(new Register32(0x00000000/*0*/));
		emulator.Memory32[new Register32(0x00489ABC/*4758204*/)] = emulator.Cpu.Mov(new Register32(0x409F4000/*1084178432*/));
		...
		emulator.Cpu.Eax = emulator.Cpu.Mov(emulator.Memory32[emulator.Cpu.Esi + new Register32(0x00491BD8/*4791256*/)]);
		emulator.Cpu.Cdq();
		...
		emulator.Cpu.Fild(emulator.Memory32[emulator.Cpu.Esi + new Register32(0x00491BBC/*4791228*/)]);
		emulator.Cpu.Fpu.Stack[0] = emulator.Cpu.Fmul(emulator.Cpu.Fpu.Stack[0], new Register64(0x4004000000000000)/*2.5*/);
		...
		emulator.Cpu.Fild(emulator.Memory32[emulator.Cpu.Esi + new Register32(0x00491BC8/*4791240*/)]);
		emulator.Cpu.Fpu.Stack[0] = emulator.Cpu.Fmul(emulator.Cpu.Fpu.Stack[0], new Register64(0x4004000000000000)/*2.5*/);
		emulator.Cpu.Call(new Register32(0x004360C4/*4415684*/));
		...
		emulator.Cpu.Eax = emulator.Cpu.Mov(emulator.Memory32[emulator.Cpu.Esi + new Register32(0x00491BD8/*4791256*/)]);
		emulator.Cpu.Cdq();
		emulator.Cpu.Edx = emulator.Cpu.And(emulator.Cpu.Edx, new Register8(0x03/*3*/));
		emulator.Cpu.Eax = emulator.Cpu.Add(emulator.Cpu.Eax, emulator.Cpu.Edx);
		emulator.Cpu.Eax = emulator.Cpu.Sar(emulator.Cpu.Eax, new Register8(0x02/*2*/));
		emulator.Memory32[emulator.Cpu.Esi + new Register32(0x00491BD8/*4791256*/)] = emulator.Cpu.Mov(emulator.Cpu.Eax);
		emulator.Cpu.Fild(emulator.Memory32[emulator.Cpu.Esi + new Register32(0x00491BBC/*4791228*/)]);
		emulator.Cpu.Fpu.Stack[0] = emulator.Cpu.Fmul(emulator.Cpu.Fpu.Stack[0], new Register64(0x4008000000000000)/*3*/);
		emulator.Cpu.Call(new Register32(0x004360C4/*4415684*/));
		emulator.Memory32[emulator.Cpu.Esi + new Register32(0x00491BBC/*4791228*/)] = emulator.Cpu.Mov(emulator.Cpu.Eax);
		emulator.Cpu.Fild(emulator.Memory32[emulator.Cpu.Esi + new Register32(0x00491BC8/*4791240*/)]);
		emulator.Cpu.Fpu.Stack[0] = emulator.Cpu.Fmul(emulator.Cpu.Fpu.Stack[0], new Register64(0x4008000000000000)/*3*/);
		...
		emulator.Cpu.Push(new Register32(0x4070E000/*1081139200*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register32(0x40945000/*1083461632*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register32(0xC0BF9000/*3233779712*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register8(0x02/*2*/));
		...
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register32(0xC0B2E800/*3232950272*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		...
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register32(0xC0A3D800/*3231963136*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register32(0xC0B3EC00/*3233016832*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register8(0x03/*3*/));
		emulator.Cpu.Push(new Register8(0x02/*2*/));
		emulator.Cpu.Call(new Register32(0x0041EE20/*4320800*/));
		...
		emulator.Cpu.Push(new Register32(0x40977000/*1083666432*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register32(0xC0AA2C00/*3232377856*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register8(0x03/*3*/));
		emulator.Cpu.Push(new Register8(0x02/*2*/));
		emulator.Cpu.Call(new Register32(0x0041EE20/*4320800*/));
		...
		emulator.Cpu.Push(new Register32(0x40977000/*1083666432*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register32(0xC0A90000/*3232301056*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register8(0x03/*3*/));
		emulator.Cpu.Push(new Register8(0x02/*2*/));
		emulator.Cpu.Call(new Register32(0x0041EE20/*4320800*/));
		...
		emulator.Cpu.Push(new Register32(0x40977000/*1083666432*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register32(0xC0A7D400/*3232224256*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register8(0x02/*2*/));
		emulator.Cpu.Push(new Register8(0x02/*2*/));
		...
		emulator.Cpu.Push(new Register32(0xC0A90000/*3232301056*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register32(0xC0A3EC00/*3231968256*/));
		emulator.Cpu.Push(new Register8(0x00/*0*/));
		emulator.Cpu.Push(new Register8(0x03/*3*/));
		emulator.Cpu.Push(new Register8(0x02/*2*/));
		...
		emulator.Memory16[new Register32(0x00487996/*4749718*/)] = emulator.Cpu.Mov(new Register16(0x0000/*0*/));
		emulator.Memory16[new Register32(0x00487998/*4749720*/)] = emulator.Cpu.Mov(new Register16(0x0000/*0*/));
		emulator.Memory32[new Register32(0x004879F0/*4749808*/)] = emulator.Cpu.Mov(new Register32(0x00000000/*0*/));
		emulator.Memory32[new Register32(0x004879F4/*4749812*/)] = emulator.Cpu.Mov(new Register32(0xC0B36000/*3232980992*/));
		emulator.Memory32[new Register32(0x004879F8/*4749816*/)] = emulator.Cpu.Mov(new Register32(0x00000000/*0*/));
		emulator.Memory32[new Register32(0x004879FC/*4749820*/)] = emulator.Cpu.Mov(new Register32(0xC0A5E000/*3232096256*/));
		emulator.Cpu.Call(new Register32(0x0041EE20/*4320800*/));
		emulator.Cpu.Push(new Register8(0x10/*16*/));
