...
internal readonly record struct FrameId(int Value) : IComparable<FrameId>, IFormattable
{
	...
	public static readonly FrameId MaxValue = new(int.MaxValue);

	public static FrameId operator ++(FrameId value) => new(value.Value + 1);
	...
	public static FrameId operator +(FrameId left, int right) => new(left.Value + right);
